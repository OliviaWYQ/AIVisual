...
export default class BasicTab extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      tabs: [
        { tab: '图片识别', key: 'img_recognition',
          url1: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/Img_fruit.jpg',
          url2: '#',
          title1: '原始图片', title2: '识别结果',
          content: '图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍图片识别介绍', 
          result: '物体名称：' },
        { tab: '图片对比', key: 'img_compare',
          ...
          content: '图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍图片对比介绍', 
          result: '相似度：'  },
        { tab: '目标统计', key: 'img_many',
          url1:'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/Img_fruit.jpg',
          url2:'#',
          title1: '原始图片', title2: '识别结果',
          content: '目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍目标统计介绍', 
          result: '总个数：'  },
      ],
      currenttab: 'tab',
      currenturl: '',
