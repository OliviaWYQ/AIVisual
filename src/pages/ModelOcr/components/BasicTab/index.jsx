...
export default class BasicTab extends Component {
  ...
  state = {
    tabs: [
      { tab: '通用文本 OCR', key: 'tongyong', id: 1, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgTY.jpg' },
      { tab: '车牌 OCR', key: 'chepai', id: 2, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgCP.jpg' },
      { tab: '身份证 OCR', key: 'shenfenzheng', id: 3, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgSFZ.jpg' },
      { tab: '营业执照 OCR', key: 'yinyezhizhao', id: 4, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgYYZZ.jpg' },
      { tab: '发票 OCR', key: 'fapiao', id: 5, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgFP.jpg' },
      { tab: '火车票 OCR', key: 'huochepiao', id: 6, url: 'https://aivisualimg.oss-cn-hangzhou.aliyuncs.com/ImgHCP.jpg' },
    ],
    currentId: 1,
    currenturl: '',
  }
